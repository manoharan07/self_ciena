...
public class CienaWsPtpInventory extends InventoryDeviceDetails {
	...
	public CienaWsPtpInventory(String ip) {
		super(ip);
	}
	  
	public CienaWsPtpInventory(String ip ,String nodeName,String nodeIp,String portType,String portId,String portName,String portLabel,String portRate,String portSpeed,Timestamp date) {
		super(ip);

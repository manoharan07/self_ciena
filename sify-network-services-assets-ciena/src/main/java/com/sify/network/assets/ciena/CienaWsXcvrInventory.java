...
public class CienaWsXcvrInventory extends InventoryDeviceDetails {
	...
	public CienaWsXcvrInventory(String ip) {
		super(ip);
	}
	  
	public CienaWsXcvrInventory(String ip ,String nodeName,String nodeIp,String portType,String portId,String portName,String portLabel,String portRate,String portSpeed,Timestamp date) {
		super(ip);
